# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 16:38:41 2024
...
from car_dynamics import ShiftedCar
from gymnasium.envs.box2d.car_racing import *
from gymnasium.envs.box2d.car_dynamics import ENGINE_POWER
# from gym.envs.classic_control.rendering import Geom, _add_attrs
# from pyglet.gl import *


class ExtendedCarRacing(CarRacing):
    def __init__(self, init_seed, stochastic, max_pos_costs, power_shift = 1, inertia_shift = 1, brake_shift=0.0, steer_shift = 0.):
        super(ExtendedCarRacing, self).__init__()
        self.deterministic = not stochastic
        self.init_seed = init_seed
        self.power_shift = power_shift
        self.inertia_shift = inertia_shift
        self.steer_shift = steer_shift
        self.brake_shift = brake_shift
        # self.seed(init_seed) out-of-date 
        self.viewer = None
        ...
        self.alpha_dict = {}
        self.rad_dict = {}
        self.reset(init_seed) # Get rid of black screen! I believe this is a bug in CarRacing-v0
    ...
    def reset(self, seed = None):
        ...
        self.car = ShiftedCar(self.world, *self.track[0][1:4], power_shift = self.power_shift, inertia_shift = self.inertia_shift, brake_shift = self.brake_shift, steer_shift = self.steer_shift)
    ...
    def step(self, action):
        ...
        if action is not None: # First step without action, called from reset()
            ...
            # print(terminated, truncated, step_reward, distance_to_track, self.car.hull.linearVelocity[0], self.car.hull.linearVelocity[1], action[2]==0)

        return self.state, (c,g), terminated, truncated, {}
    ...
    def render(self, mode='human', render_human=False):
        return self._render(mode) # Temporarily 
